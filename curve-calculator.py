...
if Entry_input == "no":
    ...
    if Secondary_input.lower() == "yes":
        Third_input = input("In Inches, Feet or Miles of Blockage?: ")
        if Third_input.lower() == "inches":
